...
namespace SnakeGame
{
    ...
    public partial class Menu : Form
    {
        ...
        {
            if (BtnExpert.Enabled == false) lblHint.Text = "Reach level 12 or higher in Normal Mode to unlock this difficulty!";
        ...
        private void BtnMaster_MouseEnter(object sender, EventArgs e)
        {
            ...
            else if (BtnExpert.Enabled == true) lblHint.Text = "Reach level 10 or higher in Expert Mode to unlock this difficulty!";
        }
    }
}
